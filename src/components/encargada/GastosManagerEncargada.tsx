...
import { GastosHistorialEncargada } from './GastosHistorialEncargada';

interface GastosManagerEncargadaProps {
  onSuccess?: () => void;
  selectedAgency: string;
  selectedDate: Date;
}

export const GastosManagerEncargada = ({ onSuccess, selectedAgency, selectedDate }: GastosManagerEncargadaProps) => {
